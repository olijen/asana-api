...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('stop_total')); ?>:</b>
	<?php echo CHtml::encode($data->stop_total); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('complate')); ?>:</b>
	<?php echo CHtml::encode($data->complate); ?>
	<br />
